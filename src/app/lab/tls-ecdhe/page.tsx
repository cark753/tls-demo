...
const steps = [
  {
    ...
    detail: (
      <>
        <div>
          <b className="text-orange-400">암호 스위트:</b> ECDHE, AES, ...
          <br />
  ...
  },
  {
    ...
    detail: (
      <>
        <div>
          <b className="text-green-300">ServerRandom:</b> 0xD4E5F6...
          <br />
          <b className="text-blue-300">서버 ECDHE 공개키:</b> 0x04AABB...
          <br />
          <b className="text-orange-400">서버 인증서:</b> (공개키 포함)
        </div>
        <div className="mt-2 text-xs text-gray-400">
          서버는 임시로 생성한 ECDHE 공개키와 인증서를 함께 보냅니다.
          <br />
  ...
  },
  {
    ...
    detail: (
      <>
        ...
        <div className="mt-2 text-xs text-gray-400">
          클라이언트도 임시 ECDHE 키쌍을 만들고, 공개키만 서버에 보냅니다.
          <br />
          비밀키는 절대 노출되지 않습니다.
        </div>
      </>
  ...
  },
  {
    ...
    subtitle:
      '서버와 클라이언트가 서로의 공개키와 자신의 비밀키로 공유 비밀값을 계산합니다.',
    detail: (
      <>
        <div>
          <b className="text-pink-300">서버:</b> (클라이언트 공개키 × 서버
          비밀키)
          <br />
          <b className="text-pink-300">클라이언트:</b> (서버 공개키 × 클라이언트
          비밀키)
          <br />
          <b className="text-yellow-300">공유 비밀값:</b> 0x8F2A...
        </div>
        <div className="mt-2 text-xs text-gray-400">
          수학적으로 두 계산 결과는 항상 같습니다.
          <br />이 값으로 Master Secret과 세션키를 파생합니다.
        </div>
      </>
    ),
  },
  {
    ...
    detail: (
      <>
        <div>
          <b className="text-orange-400">Master Secret</b> 파생 및 세션키 생성
          <br />
          <b className="text-orange-400">대칭키</b>로 모든 통신 암호화
        </div>
        <div className="mt-2 text-xs text-gray-400">
          이제부터는 대칭키로 안전하게 데이터를 주고받습니다.
          <br />
...
export default function TLSECDHE() {
  ...
  return (
    <div
      ...
      style={{
        background:
          'repeating-linear-gradient(135deg, #232526 0px, #232526 40px, #414345 40px, #414345 80px)',
      }}
    >
      <div
        className="w-full max-w-3xl rounded-3xl shadow-2xl border border-gray-700 overflow-hidden"
        style={{
      ...
      >
        {/* 헤더 */}
        <div
          className="py-7 px-8 text-center border-b border-gray-800"
          style={{
        ...
        <div className="flex flex-col items-center px-8 py-10 bg-gradient-to-br from-[#232526]/90 to-[#fbbf24]/10">
          ...
          {/* 설명 */}
          <div className="w-full text-gray-100 text-base mb-4">
            {steps[step].detail}
          </div>
